...
export const ErrorPage = ({ err }) => {
  const errorStatus = err ? "400 Bad Request" : "404 Error";
  const errorMessage = err ? err : "Page Not Found.";
  return (
    <section className="error-page-body">
      ...
      <div className="error-page-text">
        <h1 className="error-page-h1">{errorStatus}</h1>
        <h2>Couldn't launch </h2>
        <h3>
          {errorMessage} - Let's take you <Link to={`/`}>Back</Link>
        </h3>
      </div>
    </section>
  );
